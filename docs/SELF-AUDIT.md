...
针对用户反馈《[版本管理与分发问题](feedback/2026-08-16-versioning-feedback.md)》（"一个安全插件整天警告别人 git 引用未锁定，自己却以最不被推荐的方式分发"），v0.3.0 按 [VERSIONING-PLAN](VERSIONING-PLAN.md) 执行修复。与安全承诺相关的变更在此逐条公示：
