    ...
    function apply(ctx) {
      ...
      ctx.effect(() => {
        ...
        tag.textContent = [
          ...
          // EXACTLY against the 20px-line-height title that leads the main
          // column (title center = 12+10 = 22px from card top; dot center =
          // 12+6+4 = 22px) — keep these numbers in sync if the type scale
          // ever changes
          ...
          '.dsd-passgroup{overflow:hidden;border:1px solid rgba(255,255,255,.62);border-color:color-mix(in srgb,var(--dsw-alias-bg-layer-1,#fff) 64%,transparent);border-radius:16px;background:rgba(255,255,255,.38);background:color-mix(in srgb,var(--dsw-alias-bg-layer-1,#fff) 40%,transparent);box-shadow:0 1px 3px rgba(0,0,0,.04)}',
